...
public class ListPicker extends ImageComponent{
  ...
  public ListPicker(String assetPrefix) {
    super(assetPrefix);
  }
  ...
  private String generateCSSforComponent()
  {
    ...
    sb.append(" color : "+this.getItemTextColor()+";\n");
  ...
  private String generateHTMLforComponent()
  {
    ...
    {
      sb.append("<option value = "+"\""+element+"\"");      
      if(this.getSelection().equalsIgnoreCase(element))
        sb.append(" selected");
      sb.append(">");
      sb.append(element);
      sb.append("</option>");
  ...
  public ParseResult getComponentString(Map<String,JSONValue> properties)
  {
    ...
    for(String property:properties.keySet())
    {
      ...
      case "ItemBackgroundColor":
        StringBuilder itemColor = new StringBuilder(value);
        itemColor.replace(0, 4, "#");                           
        this.setItemBackgroundColor(itemColor.toString().valueOf(itemColor));
        break;
      case "ItemTextColor":
        StringBuilder itemTextColor = new StringBuilder(value);
        itemTextColor.replace(0, 4, "#");                           
        this.setItemTextColor(itemTextColor.toString().valueOf(itemTextColor));
        break;
      case "Shape":
        if(value.equals("1"))
          this.setShape("10px");
