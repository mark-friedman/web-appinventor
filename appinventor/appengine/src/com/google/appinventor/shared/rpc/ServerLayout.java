...
public class ServerLayout {
    ...
    */
    ...
    public static String genFullWebAppLaunchPath(long projectId, String currentScreenName) {
        return ODE_BASEURL + genRelativeWebAppLaunchPath(projectId, currentScreenName);
    }
